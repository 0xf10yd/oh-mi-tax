        ...
        <div>
                    ...
                    <Row className="row-2">
                        <Col md={6}>
                            <p className="white-text">
                                ...
                                helps TriChain achieve its aim. We have shifted
                                ...
                                collection. With TriChain people know whether
            ...
            <div className="white-bg">
                <Container>
                    <Row>
                        <Col md={5}>
                            <h3 className="grey">TriChain For Everyone</h3>
                        ...
                        <Col md={7}></Col>
                        <WhiteCard
                            caption="TriChain Allows Citizens to Track their Taxes. Citizens can pay taxes using Tokens, View Funds Alloted by government to various constituencies and how these funds are being used by them."
                            title="Citizen"
                            imgUrl="https://image.freepik.com/free-vector/group-young-people-waving-hand_23-2148361692.jpg"
                        ></WhiteCard>
                        <WhiteCard
                            caption="TriChain Creates Transparency.Government can know what work is being done in the constituencies."
                            title="Government"
                            imgUrl="https://image.freepik.com/free-vector/us-supreme-court-building-flat-vector-illustration_82574-4466.jpg"
                        ></WhiteCard>
                        <WhiteCard
                            caption="TriChain reduces corruption in local government bodies and prevents corrupt MLAs from using tax money for their own benefit."
